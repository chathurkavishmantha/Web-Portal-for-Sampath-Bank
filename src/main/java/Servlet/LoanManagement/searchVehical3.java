...
/**
 * Servlet implementation class searchVehical3
 */
public class searchVehical3 extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public searchVehical3() {
        super();
...
//		request.getRequestDispatcher("LoanHome.jsp").forward(request, response);
        ...
        RequestDispatcher view = request.getRequestDispatcher("/LM_LoanVehicle.jsp");
