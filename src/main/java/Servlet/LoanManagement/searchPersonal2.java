...
/**
 * Servlet implementation class searchPersonal2
 */
public class searchPersonal2 extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public searchPersonal2() {
        super();
...
//		request.getRequestDispatcher("LoanHome.jsp").forward(request, response);
        ...
        RequestDispatcher view = request.getRequestDispatcher("/LM_LoanPersonal.jsp");
