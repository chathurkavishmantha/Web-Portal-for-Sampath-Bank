...
<html lang="en">
    ...
    <body>
        ...
        <div class="container1">
            ...
            <form name="sum" action="installment.php" method="link">
            
             <!--- Header Starts from here ---->
             
					        <table align="center" width="1200" bgcolor="b2beb5">
					        <tr><td align="center" valign="middle" height="150" colspan="2"><font color="#696969"><h1>Loan Details</h1></font></td></tr>
					            
					         <!--- Body Starts from here ---->
					            
					         <tr><td> <table align="center" width="1180" bgcolor="white" >
					                        
					                                 
				              <tr><td><br><br></td></tr>                  
				          	  			<tr><td align="right" width="550"><b>Loan Name :</b></td>
							                
							                <td><% String type = (String) session.getAttribute("LoanType"); %><%= type %>
							               </td>
				                        </tr>
				                        <tr><td><br></td></tr>
				                        <tr><td align="right"><b>Total Loan Amount :</b></td>
				                            <td>Rs.<% double amount = (double) session.getAttribute("LoanAmount"); %>
				                						<%= amount %></td>
				                        </tr>
				                        <tr><td><br></td></tr>
				                        <tr><td align="right"><b>Loan Term :</b></td>
				                            <td> <% int year = (Integer) session.getAttribute("LoanDuration"); %>
				                						<%= year %>years</td></tr>
				                		<tr><td><br></td></tr>
				                        <tr><td align="right"><b>Monthly Installment will be : </b></td><td><b>Rs.<% Double yearr =(Double)session.getAttribute("year"); %><%= yearr %>
				                						  </b></td>
				                		</tr>
				                         	<tr><td><br></td></tr>
				                        <tr><td align="right" valign="top"><b>Anual Installment will be :</b></td><td>Rs.<% Double month =(Double)session.getAttribute("month"); %>
				                						<%= month %> </tr>
				            ...
				            <!--- Footer ---->
				            <tr><td align="center" height="50" valign="middle" colspan="2"><font color="silver"></font></td></tr>
