            ...
            <div class="row">
				...
				<br><br><br>
                        ...
                        <div class="col-sm-12 my-col6">
                                <a href="GenerateReportServlet" target="_self"><button type="submit" class="btn btn-primary btn-lg" id="createbutton">Get Report</button></a>
                        </div>
                        <br>
                        <div class="input-group mb-3">
                         <form action="SearchServlet" method="POST">
                                        <div class="input-group mb-3">
                                            ...
                                            <input type="text" class="form-control" name="loanType" placeholder="Enter Loan type " id="search2">&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;
                                    ...
                                    <form action="UpdateDeleteServlet" method="post">
                                          ...
                                          <tr>
                							...
                							<td><input type="hidden" name="loanRate" value="<%=search_list.get(2)%>"><%=search_list.get(2)%></td>
              	  							...
              	  							<td>	
              	  									<a href="LoanUpdateValue.jsp">
              	  									<input  type="submit" class="btn btn-info" name="ud" value="update">
              	  									</a>
                							</td>
                							<td>
