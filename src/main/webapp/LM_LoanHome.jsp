        ...
        <div class="container-fluid" style="height: 1755px ">
            ...
            <div class="row">
                ...
                <div class="col-md-10">
					...
					<img src="resourcess/images/home.png" style="width: 1225px; height: 500px">
										...
										<div class="col-md-13 crli about_grid">
											...
											<form action="search1" method="POST">
		                                        <div class="input-group mb-3">
		                                            ...
		                                            <input type="text" class="form-control" name="loanType" placeholder="Please Enter Correct Loan Type(HomeLoan) " id="search2">&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;
