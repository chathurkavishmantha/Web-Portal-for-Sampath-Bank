    ...
    <body>
        ...
        <div class="container-fluid" style="height: 1050px ">
            ...
            <div class="row">
				...
				<form style="text-align:center" action="InsertLoanServlet" method="POST" name="form2" onSubmit="return validation()">
						...
						<div class="input-group-prepend">
		                    ...
		                    <input type="text" class="form-control" name="LoanRate" >
		                </div>
						<div class="input-group-prepend">
				                    <input type="submit" onSubmit="return validation()" class="btn btn-outline-secondary" id="createbutton"  value="Create a Loan">
				        </div>	
				        <br><br><br><br><br>
				        <script type="text/javascript">
				        function validation(){
				        	var LoanType = document.form2.value;
				        	var LoanRate = document.form2.value;
